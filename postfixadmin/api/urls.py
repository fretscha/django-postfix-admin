...
urlpatterns = patterns('',
                       ...
                       url(r'^alias/(?P<pk>\d+)/$',
                           views.AliasDetail.as_view()),
                       url(r'^mailbox/$', views.MailboxListOrCreate.as_view()),
                       url(r'^mailbox/(?P<pk>\d+)/$',
                           views.MailboxDetail.as_view()),
                       url(r'^vacation/$',
                           views.VacationListOrCreate.as_view()),
                       url(r'^vacation/(?P<pk>\d+)/$',
                           views.VacationDetail.as_view()),
                       url(r'^log/$', views.LogListOrCreate.as_view()),
